...
## Overview
This is a bot designed to work with BeepBoop.  Could be hosted elsewhere, as well, but edits to the ImgurClient sections will be necessary.
If you have any questions, please send them to [Nick](nicholas.comment+latexbot@gmail.com)

Visit [Beep Boop](https://beepboophq.com/docs/article/overview) to get the scoop on the the Beep Boop hosting platform. The Slack API documentation can be found [here](https://api.slack.com/).

## Assumptions
* You have already signed up with [Beep Boop](https://beepboophq.com) and have a local fork of this project.
* If this isn't the case, contact [Nick](nicholas.comment+latexbot@gmail.com), and I can help.
